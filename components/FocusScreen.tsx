...
export const FocusScreen:React.FC<Props> = ({timerDate,currentMode,taskItems,task,isTimerRunning,completeTask,setTask,handleAddTask,
    ...
    <View style={styles.container}>
      ...
      style={styles.writeTaskWrapper}>
        ...
        <TouchableOpacity onPress={()=>handleAddTask()}>
          <View>
            <Octicons name="plus-circle" size={30} color="#fff" />
          </View>
